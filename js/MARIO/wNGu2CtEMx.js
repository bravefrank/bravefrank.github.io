...
Enjine.SpriteFont.prototype.Draw = function(a) {
	for (var b = 0; b < this.Strings.length; b++)
		for (var c = this.Strings[b], d = 0; d < c.String.length; d++) {
			...
			a.drawImage(this.Image, this.Letters[e].X, this.Letters[e].Y, this.LetterWidth, this.LetterHeight, c.X +
				this.LetterWidth * (d + 1), c.Y, this.LetterWidth, this.LetterHeight)
		}
};
...
Enjine.FrameSprite.prototype.Draw = function(a, b) {
	a.drawImage(this.Image, this.FrameX, this.FrameY, this.FrameWidth, this.FrameHeight, this.X - b.X, this.Y - b.Y,
...
Enjine.AnimatedSprite.prototype.Update = function(a) {
	if (!this.CurrentSequence.SingleFrame && this.Playing && (this.LastElapsed -= a, !(this.LastElapsed > 0))) {
		...
		if (this.FrameX > this.Image.width - this.FrameWidth && (this.FrameX = 0, this.FrameY += this.FrameHeight,
				this.FrameY > this.Image.height - this.FrameHeight)) this.FrameY = 0;
		a = !1;
		this.FrameX > this.CurrentSequence.EndColumn * this.FrameWidth && this.FrameY == this.CurrentSequence
			.EndRow * this.FrameHeight ? a = !0 : this.FrameX ==
			0 && this.FrameY > this.CurrentSequence.EndRow * this.FrameHeight && (a = !0);
		if (a) this.Looping ? (this.FrameX = this.CurrentSequence.StartColumn * this.FrameWidth, this.FrameY = this
			.CurrentSequence.StartRow * this.FrameHeight) : this.Playing = !1
	}
};
...
Enjine.Collideable.prototype = {
	...
	CheckCollision: function(a) {
		!(this.Y + this.Height < a.Y) && !(this.Y > a.Y + a.Height) && !(this.X + this.Width < a.X) && !(this
			.X > a.X + a.Width) && (this.CollisionEvent(a), a.CollisionEvent(this))
	}
};
