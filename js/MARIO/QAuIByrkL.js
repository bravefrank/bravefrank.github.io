var Mario = {
	SpriteCuts: {
		...
		GetBackgroundSheet: function() {
			for (var a = [], b = 0, c = 0, e = Enjine.Resources.Images.background.width / 32, d = Enjine
					.Resources.Images.background.height / 32, b = 0; b < e; b++) {
				a[b] = [];
				for (c = 0; c < d; c++) a[b][c] = {
					X: b * 32,
					Y: c * 32,
		...
		GetLevelSheet: function() {
			for (var a = [], b = 0, c = 0, e = Enjine.Resources.Images.map.width / 16, d = Enjine.Resources
					.Images.map.height / 16, b = 0; b < e; b++) {
				a[b] = [];
				for (c = 0; c < d; c++) a[b][c] = {
					X: b * 16,
					Y: c * 16,
	...
	Tile: {
		...
		LoadBehaviors: function() {
			for (var a = [0, 20, 28, 0, 130, 130, 130, 130, 2, 2, 2, 2, 2, 0, 138, 0, 162, 146, 154, 162, 146,
					146, 154, 146, 2, 0, 2, 2, 2, 0, 2, 0, 192, 192, 192, 192, 0, 0, 0, 0, 2, 2, 0, 0, 0, 0,
					2, 0, 0, 0, 0, 0, 0, 0, 0, 0, 2, 2
				], b = 0, b = 58; b < 128; b++) a[b] = 0;
			a[128] = 2;
			a[129] = 2;
			a[130] = 2;
			a[131] = 0;
	...
	Level: function(a, b) {
		...
		for (var c = 0, e = 0, c = 0; c < this.Width; c++) {
			...
			for (e = 0; e < this.Height; e++) this.Map[c][e] = 0, this.Data[c][e] = 0, this.SpriteTemplates[c][
				e] = null
		}
	}
};
...
Mario.BackgroundGenerator.prototype = {
	...
	GenerateOverground: function(a) {
		for (var b = this.Distant ? 4 : 6, c = this.Distant ? 2 : 1, e = Math.floor(Math.random() *
				b) + c, d = Math.floor(Math.random() * b) + c, f = 0, g = 0, h = 0, i = 0, i = 2, f = 0; f <
			this.Width; f++) {
			for (e = d; e === d;) d = Math.floor(Math.random() * b) + c;
			for (g = 0; g < this.Height; g++) h = e < d ? e : d, i = e < d ? d : e, g < h ? this.Distant ? (i =
				2, g < 2 && (i = g), a.SetBlock(f, g, 4 + i * 8)) : a.SetBlock(f, g, 5) : g === h ? (i =
				h === d ? 0 : 1, i += this.Distant ? 2 : 0, a.SetBlock(f, g, i)) : g === i ? (i = h === d ?
				0 : 1, i += this.Distant ? 2 : 0, a.SetBlock(f, g, i + 16)) : (i = g > i ? 1 : 0, h === e &&
				(i = 1 - i), i += this.Distant ? 2 : 0, a.SetBlock(f, g, i + 8))
		}
	},
	...
	GenerateCastle: function(a) {
		...
		if (this.Distant)
			for (b = 0; b < this.Width; b++)
				for (c = 0; c < this.Height; c++) e = b % 2, d = c - 1, d > 2 && d < 5 ? d = 2 : d >= 5 && (d -=
						2), d < 0 ? (e = 0, d = 5) : d > 4 ? (e = 1, d = 5) : e < 1 && d === 3 ? (e = 0, d =
					3) : e < 1 && d > 0 && d < 3 && (e = 0,
						d = 2), a.SetBlock(b, c, 1 + e + (d + 4) * 8);
		else
			for (b = 0; b < this.Width; b++)
				for (c = 0; c < this.Height; c++) e = b % 3, d = c - 1, d > 2 && d < 5 ? d = 2 : d >= 5 && (d -=
						2), d < 0 ? (e = 1, d = 5) : d > 4 ? (e = 2, d = 5) : e < 2 && d === 4 ? (e = 2, d =
					4) : e < 2 && d > 0 && d < 4 && (e = 4, d = -3), a.SetBlock(b, c, 1 + e + (d + 3) * 8)
	}
};
...
Mario.BackgroundRenderer.prototype.Draw = function(a, b) {
	for (var c = b.X / this.Distance, e = 0, d = 0, f = null, f = null, g = (c + this.Width) / 32 | 0, e = c / 32 |
			0; e <= g; e++)
		for (d = 0; d < this.TilesY; d++) f = this.Level.GetBlock(e, d) & 255, f = this.Background[f % 8][f / 8 |
			0], a.drawImage(Enjine.Resources.Images.background, f.X, f.Y, f.Width, f.Height, (e << 5) - c | 0, d <<
				5 | 0, f.Width, f.Height)
};
...
Mario.ImprovedNoise.prototype = {
	Shuffle: function() {
		...
		for (b = 0; b < 256; b++) c = (Math.random() * 255 | 0) + b, e = a[b], a[b] = a[c], a[c] = e, this.P[b +
			256] = this.P[b] = a[b]
	},
	PerlinNoise: function(a, b) {
		for (var c = 0, e = 0, d = 0, c = 0; c < 8; c++) d = 64 / (1 << c), e += this.Noise(a / d, b / d, 128) /
			(1 << c);
		return e
	},
	Noise: function(a, b, c) {
		...
		var g = this.Fade(a),
			...
			this.P[d] + f,
			f = this.P[d + 1] + f;
		return this.Lerp(i, this.Lerp(h, this.Lerp(g, this.Grad(this.P[k], a, b, c), this.Grad(this.P[e], a - 1,
			b, c)), this.Lerp(g, this.Grad(this.P[j], a, b - 1, c), this.Grad(this.P[f], a - 1, b -
			1, c))), this.Lerp(h, this.Lerp(g, this.Grad(this.P[k + 1], a, b, c - 1), this.Grad(this.P[
			e + 1], a - 1, b, c - 1)), this.Lerp(g, this.Grad(this.P[j + 1], a, b - 1, c - 1), this
			.Grad(this.P[f + 1], a - 1, b - 1, c - 1))))
	},
	Fade: function(a) {
...
Mario.NotchSprite = function(a) {
	this.YPicO = this.XPicO = this.YPic = this.XPic = this.Ya = this.Xa = this.Y = this.X = this.YOld = this.XOld =
		0;
...
Mario.NotchSprite.prototype.Draw = function(a) {
	var b = 0,
		c = 0;
	this.Visible && (b = (this.XOld + (this.X - this.XOld) * this.Delta | 0) - this.XPicO, c = (this.YOld + (this
			.Y - this.YOld) * this.Delta | 0) - this.YPicO, a.save(), a.scale(this.XFlip ? -1 : 1, this.YFlip ?
			-1 : 1), a.translate(this.XFlip ? -320 : 0, this.YFlip ? -240 : 0), a.drawImage(this.Image, this
			.XPic * this.PicWidth, this.YPic * this.PicHeight, this.PicWidth, this.PicHeight, this.XFlip ? 320 -
			b - this.PicWidth : b, this.YFlip ? 240 - c - this.PicHeight : c, this.PicWidth, this.PicHeight), a
		.restore())
};
...
Mario.Character = function() {
	...
	this.Height = 24;
	this.World = null;
	this.InvulnerableTime = this.WinTime = this.DeathTime = this.YDeathPos = this.XDeathPos = this.PowerUpTime =
		this.Facing = 0;
	this.Carried = null;
...
Mario.Character.prototype.Blink = function(a) {
	...
	this.Large ? (this.Image = this.Fire ? Enjine.Resources.Images.fireMario : Enjine.Resources.Images.mario, this
		.XPicO = 16, this.YPicO = 31, this.PicWidth = this.PicHeight = 32) : (this.Image = Enjine.Resources
		.Images.smallMario, this.XPicO = 8, this.YPicO = 15, this.PicWidth = this.PicHeight = 16)
};
Mario.Character.prototype.Move = function() {
	if (this.WinTime > 0) this.WinTime++, this.Ya = this.Xa = 0;
	else if (this.DeathTime > 0) this.DeathTime++, this.DeathTime < 11 ? this.Ya = this.Xa = 0 : this.DeathTime ===
		11 ? this.Ya = -15 : this.Ya += 2, this.X += this.Xa, this.Y += this.Ya;
	else if (this.PowerUpTime !== 0) {
		this.PowerUpTime > 0 ? (this.PowerUpTime--, this.Blink(((this.PowerUpTime / 3 | 0) & 1) === 0)) : (this
			.PowerUpTime++, this.Blink(((-this.PowerUpTime / 3 | 0) & 1) === 0));
		...
		if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.S) || this.JumpTime < 0 && !this.OnGround && !this.Sliding)
			if (this.JumpTime < 0) this.Xa = this.XJumpSpeed, this.Ya = -this.JumpTime * this.YJumpSpeed, this
				.JumpTime++;
			else if (this.OnGround && this.MayJump) Enjine.Resources.PlaySound("jump"), this.XJumpSpeed = 0, this
			.YJumpSpeed = -1.9, this.JumpTime = 7, this.Ya = this.JumpTime * this.YJumpSpeed, this.Sliding = this
			.OnGround = !1;
		else if (this.Sliding && this.MayJump) Enjine.Resources.PlaySound("jump"), this.XJumpSpeed = -this.Facing *
			6, this.YJumpSpeed = -2, this.JumpTime = -6, this.Xa = this.XJumpSpeed, this.Ya = -this.JumpTime * this
			.YJumpSpeed, this.Sliding = this.OnGround = !1, this.Facing = -this.Facing;
		else {
		...
		if (!Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Left) && !Enjine.KeyboardInput.IsKeyDown(Enjine.Keys
			.Right) || this.Ducking || this.Ya < 0 || this.OnGround) this.Sliding = !1;
		Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A) && this.CanShoot && this.Fire && this.World
			.FireballsOnScreen < 2 && (Enjine.Resources.PlaySound("fireball"), this.World.AddSprite(new Mario
				.Fireball(this.World, this.X + this.Facing * 6, this.Y - 20, this.Facing)));
		...
		if (Math.abs(this.Xa) < 0.5) this.Xa = this.RunTime =
			0;
		this.CalcPic();
		this.Sliding && (this.World.AddSprite(new Mario.Sparkle(this.World, (this.X + Math.random() * 4 - 2 | 0) +
			this.Facing * 8, (this.Y + Math.random() * 4 | 0) - 24, Math.random() * 2 - 1, Math
		.random(), 0, 1, 5)), this.Ya *= 0.5);
		this.OnGround = !1;
		...
		if (this.Carried !== null && (this.Carried.X *= this.X + this.Facing * 8, this.Carried.Y *= this.Y - 2, !
				Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A))) this.Carried.Release(this), this.Carried = null
	}
};
Mario.Character.prototype.CalcPic = function() {
	var a = 0,
		b = 0;
	this.Large ? (a = (this.RunTime / 20 | 0) % 4, a === 3 && (a = 1), this.Carried === null && Math.abs(this.Xa) >
		10 && (a += 3), this.Carried !== null && (a += 10), this.OnGround || (a = this.Carried !== null ? 12 :
			Math.abs(this.Xa) > 10 ? 7 : 6)) : (a = (this.RunTime / 20 | 0) % 2, this.Carried === null && Math
		.abs(this.Xa) > 10 && (a += 2), this.Carried !== null && (a += 8), this.OnGround || (a = this
			.Carried !== null ? 9 : Math.abs(this.Xa) > 10 ? 5 : 4));
	if (this.OnGround && (this.Facing === -1 && this.Xa > 0 || this.Facing === 1 && this.Xa < 0)) {
		if (this.Xa >
			1 || this.Xa < -1) a = this.Large ? 9 : 7;
		if (this.Xa > 3 || this.Xa < -3)
			for (b = 0; b < 3; b++) this.World.AddSprite(new Mario.Sparkle(this.World, this.X + Math.random() * 8 -
				4 | 0, this.Y + Math.random() * 4 | 0, Math.random() * 2 - 1, Math.random() * -1, 0, 1, 5))
	}
...
Mario.Character.prototype.SubMove = function(a, b) {
	...
	b > 0 && (this.IsBlocking(this.X + a - this.Width, this.Y + b, a, 0) ? c = !0 : this.IsBlocking(this.X + a +
		this.Width, this.Y + b, a, 0) ? c = !0 : this.IsBlocking(this.X + a - this.Width, this.Y + b + 1, a,
		b) ? c = !0 : this.IsBlocking(this.X + a + this.Width, this.Y + b + 1, a, b) && (c = !0));
	if (b < 0)
	...
	if (a > 0) this.Sliding = !0, this.IsBlocking(this.X + a + this.Width, this.Y + b - this.Height, a, b) ? c = !
		0 : this.Sliding = !1, this.IsBlocking(this.X + a + this.Width, this.Y + b - (this.Height / 2 | 0), a, b) ?
		c = !0 : this.Sliding = !1, this.IsBlocking(this.X + a + this.Width, this.Y + b, a, b) ? c = !0 : this
		.Sliding = !1;
	if (a < 0) this.Sliding = !0, this.IsBlocking(this.X +
		a - this.Width, this.Y + b - this.Height, a, b) ? c = !0 : this.Sliding = !1, this.IsBlocking(this.X +
		a - this.Width, this.Y + b - (this.Height / 2 | 0), a, b) ? c = !0 : this.Sliding = !1, this.IsBlocking(
		this.X + a - this.Width, this.Y + b, a, b) ? c = !0 : this.Sliding = !1;
	if (c) {
...
Mario.Character.prototype.IsBlocking = function(a, b, c, e) {
	...
	if ((Mario.Tile.Behaviors[d & 255] & Mario.Tile.PickUpable) > 0) {
		...
		for (d = 0; d < 2; d++)
			for (f = 0; f < 2; f++) this.World.AddSprite(new Mario.Sparkle(this.World, a * 16 + d * 8 + (Math
				.random() * 8 | 0), b * 16 + f * 8 + (Math.random() * 8 | 0), 0, 0, 0, 2, 5))
...
Mario.Character.prototype.Stomp = function(a) {
	...
	if (!(this.DeathTime > 0 || this.World.Paused))
		if (b = a.Y - a.Height / 2, this.SubMove(0, b - this.Y), a instanceof Mario.Enemy || a instanceof Mario
			.BulletBill) Enjine.Resources.PlaySound("kick"), this.XJumpSpeed = 0, this.YJumpSpeed = -1.9, this
			.JumpTime = 8, this.Ya = this.JumpTime * this.YJumpSpeed, this.Sliding = this.OnGround = !1, this
			.InvulnerableTime = 1;
		else if (a instanceof Mario.Shell) Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A) && a.Facing === 0 ? (this
		.Carried = a, a.Carried = !0) : (Enjine.Resources.PlaySound("kick"),
		this.XJumpSpeed = 0, this.YJumpSpeed = -1.9, this.JumpTime = 8, this.Ya = this.JumpTime * this
		.YJumpSpeed, this.Sliding = this.OnGround = !1, this.InvulnerableTime = 1)
};
Mario.Character.prototype.GetHurt = function() {
	if (!(this.DeathTime > 0 || this.World.Paused) && !(this.InvulnerableTime > 0)) this.Large ? (this.World
		.Paused = !0, this.PowerUpTime = -18, Enjine.Resources.PlaySound("powerdown"), this.Fire ? this
		.SetLarge(!0, !1) : this.SetLarge(!1, !1), this.InvulnerableTime = 32) : this.Die()
};
...
Mario.Character.prototype.GetFlower = function() {
	if (!(this.DeathTime > 0 && this.World.Paused)) this.Fire ? (this.GetCoin(), Enjine.Resources.PlaySound(
		"coin")) : (this.World.Paused = !0, this.PowerUpTime = 18, Enjine.Resources.PlaySound("powerup"), this
			.SetLarge(!0, !0))
};
Mario.Character.prototype.GetMushroom = function() {
	if (!(this.DeathTime > 0 && this.World.Paused)) this.Large ? (this.GetCoin(), Enjine.Resources.PlaySound(
		"coin")) : (this.World.Paused = !0, this.PowerUpTime = 18, Enjine.Resources.PlaySound("powerup"), this
		.SetLarge(!0, !1))
};
Mario.Character.prototype.Kick = function(a) {
	if (!(this.DeathTime > 0 && this.World.Paused)) Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A) ? (this.Carried =
		a, a.Carried = !0) : (Enjine.Resources.PlaySound("kick"), this.InvulnerableTime = 1)
};
...
Mario.LevelRenderer.prototype.DrawStatic = function(a, b) {
	for (var c = 0, e = 0, d = 0, d = null, f = (b.X + this.Width) / 16 | 0, c = b.X / 16 | 0; c < f + 1; c++)
		for (e = 0; e < this.TilesY; e++) d = this.Level.GetBlock(c, e) & 255, (Mario.Tile.Behaviors[d] & Mario.Tile
			.Animated) === 0 && (d = this.Background[d % 16][d / 16 | 0], a.drawImage(Enjine.Resources.Images
			.map, d.X, d.Y, d.Width, d.Height, (c << 4) - b.X | 0, e << 4 | 0, d.Width, d.Height))
};
Mario.LevelRenderer.prototype.DrawDynamic = function(a, b) {
	for (var c = 0, e = 0, d = 0, f = 0, g = 0, d = null, c = b.X / 16 | 0; c <= (b.X + this.Width) / 16 | 0; c++)
		for (e = b.Y / 16 | 0; e <= (b.Y + this.Height) / 16 | 0; e++) d = this.Level.GetBlock(c, e), (Mario.Tile
			.Behaviors[d & 255] & Mario.Tile.Animated) > 0 && (f = (this.Bounce / 3 | 0) % 4, (d % 16 / 4 |
			0) === 0 && (d / 16 | 0) === 1 && (f = (this.Bounce / 2 + (c + e) / 8 | 0) % 20, f > 3 && (f = 0)),
			(d % 16 / 4 | 0) === 3 && (d / 16 | 0) === 0 && (f = 2), g = 0, c >= 0 && e >= 0 && c < this.Level
			.Width && e < this.Level.Height && (g = this.Level.Data[c][e]), g > 0 && (g = Math.sin((g - this
					.Delta) /
				4 * Math.PI) * 8 | 0), d = this.Background[(d % 16 / 4 | 0) * 4 + f][d / 16 | 0], a.drawImage(
				Enjine.Resources.Images.map, d.X, d.Y, d.Width, d.Height, (c << 4) - b.X, (e << 4) - b.Y - g, d
				.Width, d.Height))
};
Mario.LevelRenderer.prototype.DrawExit0 = function(a, b, c) {
	for (var e = 0, e = 0, d = null, e = this.Level.ExitY - 8; e < this.Level.ExitY; e++) d = this.Background[12][
		e === this.Level.ExitY - 8 ? 4 : 5
	], a.drawImage(Enjine.Resources.Images.map, d.X, d.Y, d.Width, d.Height, (this.Level.ExitX << 4) - b.X - 16,
		(e << 4) - b.Y, d.Width, d.Height);
	c && (e = this.Level.ExitY * 16 - 48 - Math.sin(this.AnimTime) * 48 - 8, d = this.Background[12][3], a
		.drawImage(Enjine.Resources.Images.map, d.X, d.Y, d.Width, d.Height, (this.Level.ExitX << 4) - b.X - 16,
			e - b.Y, d.Width, d.Height), d = this.Background[13][3],
		a.drawImage(Enjine.Resources.Images.map, d.X, d.Y, d.Width, d.Height, (this.Level.ExitX << 4) - b.X, e -
			b.Y, d.Width, d.Height))
};
Mario.LevelRenderer.prototype.DrawExit1 = function(a, b) {
	for (var c = 0, e = null, c = this.Level.ExitY - 8; c < this.Level.ExitY; c++) e = this.Background[13][c ===
		this.Level.ExitY - 8 ? 4 : 5
	], a.drawImage(Enjine.Resources.Images.map, e.X, e.Y, e.Width, e.Height, (this.Level.ExitX << 4) - b.X + 16,
		(c << 4) - b.Y, e.Width, e.Height)
};
...
Mario.LevelGenerator.prototype = {
	CreateLevel: function(a, b) {
		...
		for (c = 0; c < this.Odds.length; c++) this.Odds[c] < 0 && (this.Odds[c] = 0), this.TotalOdds += this
			.Odds[c], this.Odds[c] = this.TotalOdds - this.Odds[c];
		i = new Mario.Level(this.Width, this.Height);
		for (e += this.BuildStraight(i, 0, i.Width, !0); e < i.Width - 64;) e += this.BuildZone(i, e, i.Width -
			e);
	...
	BuildZone: function(a,
		b, c) {
		for (var e = Math.random() * this.TotalOdds | 0, d = 0, f = 0, f = 0; f < this.Odds.length; f++) this
			.Odds[f] <= e && (d = f);
		switch (d) {
	...
	BuildJump: function(a, b) {
		for (var c = (Math.random() * 4 | 0) + 2, e = c * 2 + ((Math.random() * 2 | 0) + 2), d = 0, f =
				0, g = (Math.random() * 3 | 0) === 0, h = this.Height - 1 - (Math.random() * 4 | 0), d = b; d <
			b + e; d++)
			if (d < b + c || d > b + e - c - 1)
				for (f = 0; f < this.Height; f++) f >= h ? a.SetBlock(d, f, 145) : g && (d < b + c ? f >= h - (
					d - b) + 1 && a.SetBlock(d, f, 9) : f >= h - (b + e - d) + 2 && a.SetBlock(d, f, 9));
		return e
	},
	BuildCannons: function(a, b, c) {
		...
		for (g = b; g < b + e; g++) {
			...
			for (h = 0; h < this.Height; h++) h >=
				d ? a.SetBlock(g, h, 145) : g === f && h >= i && (h === i ? a.SetBlock(g, h, 14) : h === i + 1 ?
					a.SetBlock(g, h, 30) : a.SetBlock(g, h, 46))
		}
		return e
	},
	BuildHillStraight: function(a, b, c) {
		...
		for (this.AddEnemyLine(a, b + 1, b + e - 1, d - 1); i;)
			...
			else if (j = (Math.random() * 5 | 0) + 3, k = (Math.random() * (e - j - 2) | 0) + b + 1, l[k - b] ||
			l[k - b + j] || l[k - b -
				1] || l[k - b + j + 1]) i = !1;
		else {
			l[k - b] = !0;
			...
			for (f = k; f < k + j; f++)
				for (g = h; g < d; g++) m = 5, n = 9, f === k && (m = 4), f === k + j - 1 && (m = 6), g === h &&
					(n = 8), a.GetBlock(f, g) === 0 ? a.SetBlock(f, g, m + n * 16) : (a.GetBlock(f, g) ===
						132 && a.SetBlock(f, g, 180), a.GetBlock(f, g) === 134 && a.SetBlock(f, g, 182))
		}
		return e
	},
	AddEnemyLine: function(a, b, c, e) {
		for (var d = 0, f = 0, d = b; d < c; d++)
			if ((Math.random() * 35 | 0) < this.Difficulty + 1) f = Math.random() * 4 | 0, this.Difficulty <
				1 ? f = Mario.Enemy.Goomba : this.Difficulty < 3 && (f = Math.random() * 3 | 0), a
				.SetSpriteTemplate(d, e, new Mario.SpriteTemplate(f, (Math.random() * 35 | 0) < this
					.Difficulty))
	},
	BuildTubes: function(a, b, c) {
		...
		for (h = b; h < b + e; h++) {
			...
			f >= b + e - 2 && (f += 10);
			h === f && (Math.random() * 11 | 0) < this.Difficulty + 1 && a.SetSpriteTemplate(h, g, new Mario
				.SpriteTemplate(Mario.Enemy.Flower,
					!1));
			for (i = 0; i < this.Height; i++)
				if (i >= d) a.SetBlock(h, i, 145);
				else if ((h === f || h === f + 1) && i >= g) j = 10 + h - f, i === g ? a.SetBlock(h, i, j) : a
				.SetBlock(h, i, j + 16)
		}
		return e
	},
	...
	Decorate: function(a, b, c, e) {
		if (!(e < 1)) {
			...
			if (e - 4 > 0 && c - 1 - f - (b + 1 + d) > 2)
				for (g = b + 1 + d; g < c - 1 - f; g++) g !== b + 1 && g !== c - 2 && (Math.random() * 3 |
					0) === 0 ? (Math.random() * 4 | 0) === 0 ? a.SetBlock(g, e - 4, 22) : a.SetBlock(g, e - 4,
						21) : (Math.random() * 4 | 0) === 0 ? (Math.random() * 4 | 0) === 0 ? a.SetBlock(g, e -
						4, 18) : a.SetBlock(g, e - 4, 17) : a.SetBlock(g, e - 4, 16)
		}
	},
	FixWalls: function(a) {
	...
	Blockify: function(a, b, c, e) {
		...
		for (g = 0; g < c; g++)
			for (h = 0; h < e; h++) {
				for (i = g; i <= g + 1; i++)
					for (j = h; j <= h + 1; j++) k = i, l = j, k < 0 && (k = 0), l < 0 && (l = 0), k > c - 1 &&
						(k = c - 1), l > e - 1 && (l = e - 1), f[i - g][j - h] = b[k][l];
				f[0][0] === f[1][0] && f[0][1] ===
					f[1][1] ? f[0][0] === f[0][1] ? f[0][0] && a.SetBlock(g, h, 145 + d) : f[0][0] ? a.SetBlock(
						g, h, 161 + d) : a.SetBlock(g, h, 129 + d) : f[0][0] === f[0][1] && f[1][0] === f[1][
					1] ? f[0][0] ? a.SetBlock(g, h, 146 + d) : a.SetBlock(g, h, 144 + d) : f[0][0] === f[1][
					1] && f[0][1] === f[1][0] ? a.SetBlock(g, h, 145 + d) : f[0][0] === f[1][0] ? f[0][0] ? f[0]
					[1] ? a.SetBlock(g, h, 163 + d) : a.SetBlock(g, h, 179 + d) : f[0][1] ? a.SetBlock(g, h,
						130 + d) : a.SetBlock(g, h, 128 + d) : f[0][1] === f[1][1] ? f[0][1] ? f[0][0] ? a
					.SetBlock(g, h, 147 + d) : a.SetBlock(g, h, 131 + d) : f[0][0] ? a.SetBlock(g, h, 162 + d) :
					a.SetBlock(g,
...
Mario.SpriteTemplate.prototype = {
	Spawn: function(a, b, c, e) {
		if (!this.IsDead) this.Sprite = this.Type === Mario.Enemy.Flower ? new Mario.FlowerEnemy(a, b * 16 + 15,
				c * 16 + 24) : new Mario.Enemy(a, b * 16 + 8, c * 16 + 15, e, this.Type, this.Winged), this
			.Sprite.SpriteTemplate = this, a.AddSprite(this.Sprite)
	}
};
...
Mario.Enemy.prototype.CollideCheck = function() {
	if (this.DeadTime === 0) {
		...
		if (a > -this.Width * 2 - 4 && a < this.Width * 2 + 4 && b > -this.Height && b < Mario.MarioCharacter
			.Height)
			if (this.Type !== Mario.Enemy.Spiky && Mario.MarioCharacter.Ya > 0 && b <= 0 && (!Mario.MarioCharacter
					.OnGround || !Mario.MarioCharacter.WasOnGround))
				if (Mario.MarioCharacter.Stomp(this), this.Winged) this.Winged = !1, this.Ya = 0;
					...
					this.DeadTime = 10;
					this.Winged = !1;
					this.Type === Mario.Enemy.RedKoopa ? this.World.AddSprite(new Mario.Shell(this.World, this.X,
						this.Y, 0)) : this.Type === Mario.Enemy.GreenKoopa && this.World.AddSprite(new Mario
						.Shell(this.World, this.X, this.Y, 1))
				}
...
Mario.Enemy.prototype.Move = function() {
	...
	if (this.DeadTime > 0) {
		...
		if (this.DeadTime === 0) {
			this.DeadTime = 1;
			for (a = 0; a < 8; a++) this.World.AddSprite(new Mario.Sparkle(this.World, (this.X + Math.random() *
					16 - 8 | 0) + 4, (this.Y - Math.random() * 8 | 0) + 4, Math.random() * 2 - 1, Math
				.random() * -1, 0, 1, 5));
...
Mario.Enemy.prototype.SubMove = function(a, b) {
	...
	a > 0 && (this.IsBlocking(this.X + a + this.Width, this.Y + b - this.Height, a, b) && (c = !0), this.IsBlocking(
			this.X + a + this.Width, this.Y + b - (this.Height / 2 | 0), a, b) && (c = !0), this.IsBlocking(this
			.X + a + this.Width, this.Y + b, a, b) && (c = !0), this.AvoidCliffs && this.OnGround && !this.World
		.Level.IsBlocking((this.X + this.Xa + this.Width) / 16 | 0, this.Y /
			16 + 1 | 0, this.Xa, 1) && (c = !0));
	a < 0 && (this.IsBlocking(this.X + a - this.Width, this.Y + b - this.Height, a, b) && (c = !0), this.IsBlocking(
			this.X + a - this.Width, this.Y + b - (this.Height / 2 | 0), a, b) && (c = !0), this.IsBlocking(this
			.X + a - this.Width, this.Y + b, a, b) && (c = !0), this.AvoidCliffs && this.OnGround && !this.World
		.Level.IsBlocking((this.X + this.Xa - this.Width) / 16 | 0, this.Y / 16 + 1 | 0, this.Xa, 1) && (c = !0)
		);
	if (c) {
		if (a < 0) this.X = ((this.X - this.Width) / 16 | 0) * 16 + this.Width, this.Xa = 0;
...
Mario.Enemy.prototype.BumpCheck = function(a, b) {
	if (this.DeadTime === 0 && this.X + this.Width > a * 16 && this.X - this.Width < a * 16 + 16 && b === (this.Y -
			1) / 16 | 0) {
		Enjine.Resources.PlaySound("kick");
...
Mario.Enemy.prototype.Draw = function(a, b) {
	var c = 0,
		e = 0;
	if (this.Winged && (c = (this.XOld + (this.X - this.XOld) * this.Delta | 0) - this.XPicO, e = (this.YOld + (this
				.Y - this.YOld) * this.Delta | 0) - this.YPicO, this.Type !== Mario.Enemy.RedKoopa && this.Type !==
			Mario.Enemy.GreenKoopa)) this.XFlip = !this.XFlip, a.save(), a.scale(this.XFlip ? -1 : 1, this.YFlip ? -
			1 : 1), a.translate(this.XFlip ? -320 : 0, this.YFlip ? -240 : 0), a.drawImage(this.Image, (this
				.WingTime / 4 | 0) % 2 * 16, 128, 16, 32, this.XFlip ? 320 - c - 24 : c - 8, this.YFlip ? 240 - e -
			32 : e - 8, 16, 32), a.restore(),
		this.XFlip = !this.XFlip;
	this.SubDraw(a, b);
	this.Winged && (c = (this.XOld + (this.X - this.XOld) * this.Delta | 0) - this.XPicO, e = (this.YOld + (this.Y -
			this.YOld) * this.Delta | 0) - this.YPicO, this.Type === Mario.Enemy.RedKoopa && this.Type === Mario
		.Enemy.GreenKoopa ? (a.save(), a.scale(this.XFlip ? -1 : 1, this.YFlip ? -1 : 1), a.translate(this
			.XFlip ? -320 : 0, this.YFlip ? -240 : 0), a.drawImage(this.Image, (this.WingTime / 4 | 0) % 2 *
			16, 128, 16, 32, this.XFlip ? 320 - c - 24 : c - 8, this.YFlip ? 240 - e : e - 8, 16, 32)) : (a
			.save(), a.scale(this.XFlip ? -1 : 1, this.YFlip ? -1 : 1), a.translate(this.XFlip ?
				-320 : 0, this.YFlip ? -240 : 0), a.drawImage(this.Image, (this.WingTime / 4 | 0) % 2 * 16, 128,
				16, 32, this.XFlip ? 320 - c - 24 : c - 8, this.YFlip ? 240 - e - 32 : e - 8, 16, 32)), a
		.restore())
};
...
Mario.Fireball.prototype.Move = function() {
	var a = 0;
	if (this.DeadTime > 0) {
		for (a = 0; a < 8; a++) this.World.AddSprite(new Mario.Sparkle(this.World, (this.X + Math.random() * 8 - 4 |
				0) + 4, (this.Y + Math.random() * 8 - 4 | 0) + 2, Math.random() * 2 - 1 * this.Facing, Math
			.random() * 2 - 1, 0, 1, 5));
		this.World.RemoveSprite(this)
	} else {
...
Mario.Fireball.prototype.SubMove = function(a, b) {
	...
	a > 0 && (this.IsBlocking(this.X + a + this.Width, this.Y + b - this.Height, a, b) && (c = !0), this.IsBlocking(
		this.X + a + this.Width, this.Y + b - (this.Height / 2 | 0), a, b) && (c = !0), this.IsBlocking(this
		.X + a + this.Width, this.Y + b, a, b) && (c = !0));
	a < 0 && (this.IsBlocking(this.X + a - this.Width, this.Y + b - this.Height, a, b) && (c = !0), this.IsBlocking(
		this.X + a -
		this.Width, this.Y + b - (this.Height / 2 | 0), a, b) && (c = !0), this.IsBlocking(this.X + a - this
		.Width, this.Y + b, a, b) && (c = !0));
	if (c) {
		if (a < 0) this.X = ((this.X - this.Width) / 16 | 0) * 16 + this.Width, this.Xa = 0;
		if (a > 0) this.X = ((this.X + this.Width) / 16 + 1 | 0) * 16 - this.Width - 1, this.Xa = 0;
...
Mario.CoinAnim.prototype.Move = function() {
	...
	if (this.Life-- < 0) {
		this.World.RemoveSprite(this);
		for (a = 0; a < 2; a++)
			for (b = 0; b < 2; b++) this.World.AddSprite(new Mario.Sparkle(this.World, this.X + a * 8 + Math
			.random() * 8 | 0, this.Y + b * 8 + Math.random() * 8 | 0, 0, 0, 0, 2, 5))
	}
...
Mario.Mushroom.prototype.CollideCheck = function() {
	var a = Mario.MarioCharacter.X - this.X,
		b = Mario.MarioCharacter.Y - this.Y;
	a > -16 && a < 16 && b > -this.Height && b < Mario.MarioCharacter.Height && (Mario.MarioCharacter.GetMushroom(),
		this.World.RemoveSprite(this))
};
...
Mario.Mushroom.prototype.BumpCheck = function(a, b) {
	if (this.X + this.Width > a * 16 && this.X - this.Width < a * 16 - 16 && b === (b - 1) / 16 | 0) this.Facing = -
		Mario.MarioCharacter.Facing, this.Ya = -10
};
...
Mario.FireFlower.prototype.CollideCheck = function() {
	var a = Mario.MarioCharacter.X - this.X,
		b = Mario.MarioCharacter.Y - this.Y;
	a > -16 && a < 16 && b > -this.Height && b < Mario.MarioCharacter.Height && (Mario.MarioCharacter.GetFlower(),
		this.World.RemoveSprite(this))
};
...
Mario.BulletBill.prototype.CollideCheck = function() {
	if (!this.Dead) {
		var a = Mario.MarioCharacter.X - this.X,
			b = Mario.MarioCharacter.Y - this.Y;
		if (a > -16 && a < 16 && b > -this.Height && b < this.World.Mario.Height) Mario.MarioCharacter.Y > 0 && b <=
			0 && (!Mario.MarioCharacter.OnGround || !Mario.MarioCharacter.WasOnGround) ? (Mario.MarioCharacter
				.Stomp(this), this.Dead = !0, this.Xa = 0, this.Ya = 1, this.DeadTime = 100) : Mario.MarioCharacter
			.GetHurt()
	}
};
Mario.BulletBill.prototype.Move = function() {
	...
	if (this.DeadTime > 0) {
		...
		if (this.DeadTime === 0) {
			this.DeadTime = 1;
			for (a = 0; a < 8; a++) this.World.AddSprite(new Mario.Sparkle((this.X + Math.random() * 16 - 8 | 0) +
					4, (this.Y + Math.random() * 8 | 0) + 4, Math.random() * 2 - 1, Math.random() * -1, 0, 1, 5
					));
			this.World.RemoveSprite(this)
		}
		this.X += this.Xa;
...
Mario.BulletBill.prototype.ShellCollideCheck = function(a) {
	...
	var b = a.X - this.X,
		c = a.Y - this.Y;
	if (b > -16 && b < 16 && c > -this.Height && c < a.Height) return Enjine.Resources.PlaySound("kick"), this
		.Dead = !0, this.Xa = 0, this.Ya = 1, this.DeadTime = 100, !0;
	return !1
};
...
Mario.FlowerEnemy.prototype.Move = function() {
	...
	if (this.DeadTime > 0) {
		...
		this.Ya *= 0.95;
		this.Ya += 1
	} else this.Tick++, this.Y >= this.YStart ? (this.YStart = this.Y, a = Math.abs(Mario.MarioCharacter.X - this
			.X) | 0, this.JumpTime++, this.Ya =
			this.JumpTime > 40 && a > 24 ? -8 : 0) : this.JumpTime = 0, this.Y += this.Ya, this.Ya *= 0.9, this
		.Ya += 0.1, this.XPic = ((this.Tick / 2 | 0) & 1) * 2 + ((this.Tick / 6 | 0) & 1)
};
...
Mario.Shell.prototype.CollideCheck = function() {
	if (!this.Carried && !(this.Dead || this.DeadTime > 0)) {
		var a = Mario.MarioCharacter.X - this.X,
			b = Mario.MarioCharacter.Y - this.Y;
		if (a > -16 && a < 16 && b > -this.Height && b < Mario.MarioCharacter.Height) Mario.MarioCharacter.Ya > 0 &&
			b <= 0 && (!Mario.MarioCharacter.OnGround || !Mario.MarioCharacter.WasOnGround) ? (Mario.MarioCharacter
				.Stomp(this), this.Facing = this.Facing !== 0 ? this.Xa = 0 : Mario.MarioCharacter.Facing) : this
			.Facing !== 0 ? Mario.MarioCharacter.GetHurt() : (Mario.MarioCharacter.Kick(this),
...
Mario.Shell.prototype.BumpCheck = function(a, b) {
	if (this.X + this.Width > a * 16 && this.X - this.Width < a * 16 + 16 && b === ((this.Y - 1) / 16 | 0)) this
		.Facing = -Mario.MarioCharacter.Facing, this.Ya = -10
};
...
Mario.Shell.prototype.ShellCollideCheck = function(a) {
	...
	if (b > -16 && b < 16 && c > -this.Height && c < a.Height) {
		Enjine.Resources.PlaySound("kick");
		if (Mario.MarioCharacter.Carried === a || Mario.MarioCharacter.Carried === this) Mario.MarioCharacter
			.Carried = null;
		this.Die();
		a.Die();
		return !0
...
Mario.LoadingState.prototype.Enter = function() {
	...
	(new Audio).canPlayType("audio/mp3") ? Enjine.Resources.AddSound("1up", "sounds/1-up.mp3", 1).AddSound(
			"breakblock", "sounds/breakblock.mp3").AddSound("bump", "sounds/bump.mp3", 4).AddSound("cannon",
			"sounds/cannon.mp3").AddSound("coin", "sounds/coin.mp3", 5).AddSound("death", "sounds/death.mp3",
			1).AddSound("exit", "sounds/exit.mp3", 1).AddSound("fireball", "sounds/fireball.mp3", 1).AddSound(
			"jump", "sounds/jump.mp3").AddSound("kick", "sounds/kick.mp3").AddSound("pipe", "sounds/pipe.mp3", 1)
		.AddSound("powerdown", "sounds/powerdown.mp3", 1).AddSound("powerup", "sounds/powerup.mp3", 1).AddSound(
			"sprout", "sounds/sprout.mp3", 1).AddSound("stagestart", "sounds/stagestart.mp3", 1).AddSound("stomp",
			"sounds/stomp.mp3", 2) : Enjine.Resources.AddSound("1up", "sounds/1-up.wav", 1).AddSound("breakblock",
			"sounds/breakblock.wav").AddSound("bump",
			"sounds/bump.wav", 2).AddSound("cannon", "sounds/cannon.wav").AddSound("coin", "sounds/coin.wav", 5)
		.AddSound("death", "sounds/death.wav", 1).AddSound("exit", "sounds/exit.wav", 1).AddSound("fireball",
			"sounds/fireball.wav", 1).AddSound("jump", "sounds/jump.wav", 1).AddSound("kick", "sounds/kick.wav", 1)
		.AddSound("message", "sounds/message.wav", 1).AddSound("pipe", "sounds/pipe.wav", 1).AddSound("powerdown",
			"sounds/powerdown.wav", 1).AddSound("powerup", "sounds/powerup.wav", 1).AddSound("sprout",
			"sounds/sprout.wav", 1).AddSound("stagestart",
...
Mario.WinState.prototype.CheckForChange = function(a) {
	this.waitTime <= 0 && this.wasKeyDown && !Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.S) && a.ChangeState(
...
Mario.MapState = function() {
	...
	this.Level = [];
	this.Data = [];
	this.YFarthestCap = this.XFarthestCap = this.Farthest = this.LevelId = this.MoveTime = this.YMarioA = this
		.XMarioA = this.YMario = this.XMario = 0;
...
Mario.MapState.prototype.Enter = function() {
	...
	this.DecoSprite.PlaySequence("world" + this.WorldNumber %
		4, !0);
	Mario.MarioCharacter.Fire ? this.LargeMario.PlaySequence("fire", !0) : this.LargeMario.PlaySequence("large", !
	0);
	this.EnterLevel = !1;
	this.LevelType = this.LevelDifficulty = 0
};
...
Mario.MapState.prototype.NextWorld = function() {
	...
	if (this.WorldNumber !== 8) {
		for (this.YFarthestCap = this.XFarthestCap = this.Farthest = this.LevelId = this.MoveTime = 0; !a;) a = this
			.GenerateLevel();
		this.RenderStatic()
	}
};
Mario.MapState.prototype.GenerateLevel = function() {
	...
	this.Level = [];
	this.Data = [];
	for (var h = Math.random() * 512, i = Math.random() * 512, j = Math.random() * 512, k = Math.random() * 512, a =
			0; a < 21; a++) {
		this.Level[a] = [];
		this.Data[a] = [];
		for (b = 0; b < 16; b++) c = d.PerlinNoise(a * 10 + h, b * 10 + i), e = f.PerlinNoise(a * 10 + j, b * 10 +
				k),
			c -= e, c *= 2, this.Level[a][b] = c > 0 ? Mario.MapTile.Water : Mario.MapTile.Grass
	}
	f = d = 9999;
	for (j = c = j = 0; j < 100 && c < 12; j++)
		if (a = (Math.random() * (20 / 3 | 0) | 0) * 3 + 2, b = (Math.random() * 5 | 0) * 3 + 1, this.Level[a][
			b] === Mario.MapTile.Grass) a < d && (d = a, f = b), this.Level[a][b] = Mario.MapTile.Level, this.Data[
			a][b] = -1, c++;
	this.Data[d][f] = -2;
	...
	for (a =
		0; a < 21; a++)
		for (b = 0; b < 16; b++)
			if (this.Level[a][b] === Mario.MapTile.Grass && (a !== this.XFarthestCap || b !== this.YFarthestCap -
				1))
...
Mario.MapState.prototype.FindConnection = function(a, b) {
	for (var c = 0, e = 0, c = 0; c < a; c++)
		for (e = 0; e < b; e++)
			if (this.Level[c][e] === Mario.MapTile.Level && this.Data[c][e] === -1) return this.Connect(c, e, a, b),
				!0;
	return !1
};
Mario.MapState.prototype.Connect = function(a, b, c, e) {
	for (var d = 1E4, f = 0, g = 0, h = 0, i = 0, j = 0, k = 0, h = j = 0; h < c; h++)
		for (i = 0; i < e; i++) this.Level[h][i] === Mario.MapTile.Level && this.Data[h][i] === -2 && (j = Math.abs(
			a - h) | 0, k = Math.abs(b - i) | 0, j = j * j + k * k, j < d && (f = h, g = i, d = j));
...
Mario.MapState.prototype.Travel = function(a, b, c, e) {
	if (!(this.Level[a][b] !== Mario.MapTile.Road && this.Level[a][b] !== Mario.MapTile.Level)) {
		...
		if (this.Level[a][b] === Mario.MapTile.Level)
			if (this.Data[a][b] > 0) this.Data[a][b] = this.LevelId !== 0 && (Math.random() * 4 | 0) === 0 ? -3 : ++
				this.LevelId;
			else if (e > 0 && (this.Data[a][b] = -1, e > this.Farthest)) this.Farthest = e, this.XFarthestCap = a,
			this.YFarthestCap = b;
...
Mario.MapState.prototype.RenderStatic = function() {
	for (var a = 0, b = 0, c = 0, e = 0, d = 0, f = 0, g = c = 0, h = 0, i = Enjine.Resources.Images.worldMap, a =
			g = 0; a < 20; a++)
		for (b = 0; b < 15; b++)
			if (this.MapContext.drawImage(i, (this.WorldNumber / 4 | 0) * 16, 0, 16, 16, a * 16, b * 16, 16, 16),
				this.Level[a][b] === Mario.MapTile.Level) g = this.Data[a][b], g === 0 ? this.MapContext.drawImage(
				i, 0, 112, 16, 16, a * 16, b * 16, 16, 16) : g === -1 ? this.MapContext.drawImage(i, 48, 128,
				16, 16, a * 16, b * 16, 16, 16) : g === -3 ? this.MapContext.drawImage(i, 0, 128, 16, 16, a *
				16, b * 16, 16, 16) : g === -10 ? this.MapContext.drawImage(i,
				16, 128, 16, 16, a * 16, b * 16, 16, 16) : g === -11 ? this.MapContext.drawImage(i, 16, 112, 16,
				16, a * 16, b * 16, 16, 16) : g === -2 ? (this.MapContext.drawImage(i, 32, 112, 16, 16, a * 16,
					(b - 1) * 16, 16, 16), this.MapContext.drawImage(i, 32, 128, 16, 16, a * 16, b * 16, 16,
				16)) : this.MapContext.drawImage(i, (g - 1) * 16, 96, 16, 16, a * 16, b * 16, 16, 16);
			else if (this.Level[a][b] === Mario.MapTile.Road) c = this.IsRoad(a - 1, b) ? 1 : 0, e = this.IsRoad(a,
			b - 1) ? 1 : 0, d = this.IsRoad(a + 1, b) ? 1 : 0, f = this.IsRoad(a, b + 1) ? 1 : 0, c = c + e * 2 +
		d * 4 + f * 8, this.MapContext.drawImage(i, c * 16, 32, 16, 16, a * 16, b * 16,
			16, 16);
	else if (this.Level[a][b] === Mario.MapTile.Water)
		for (g = 0; g < 2; g++)
			for (h = 0; h < 2; h++) c = this.IsWater(a * 2 + (g - 1), b * 2 + (h - 1)) ? 0 : 1, e = this.IsWater(a *
					2 + g, b * 2 + (h - 1)) ? 0 : 1, d = this.IsWater(a * 2 + (g - 1), b * 2 + h) ? 0 : 1, f = this
				.IsWater(a * 2 + g, b * 2 + h) ? 0 : 1, c = c + e * 2 + d * 4 + f * 8 - 1, c >= 0 && c <= 14 && this
				.MapContext.drawImage(i, c * 16, (4 + (g + h & 1)) * 16, 16, 16, a * 16 + g * 8, b * 16 + h * 8, 16,
					16)
};
...
Mario.MapState.prototype.Update = function(a) {
	...
	if (this.WorldNumber !== 8) {
		...
		if (this.MoveTime > 0) this.MoveTime--;
			...
			if (this.CanEnterLevel && Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.S) && this.Level[b][c] === Mario
				.MapTile.Level && this.Data[b][c] !== -11 && this.Level[b][c] === Mario.MapTile.Level && this.Data[
					b][c] !== 0 && this.Data[b][c] >
				-10) {
				...
				this.Data[b][c] < 0 ? (this.Data[b][c] === -2 ? (Mario.MarioCharacter.LevelString += "X", e += 2) :
						this.Data[b][c] === -1 ? Mario.MarioCharacter.LevelString += "?" : (Mario.MarioCharacter
							.LevelString += "#", e += 1), d = Mario.LevelType.Castle) : Mario.MarioCharacter
					.LevelString += this.Data[b][c];
				this.EnterLevel = !0;
		...
		Mario.MarioCharacter.Large ? (this.LargeMario.X = this.XMario + this.XMarioA * a | 0, this.LargeMario.Y =
			this.YMario + (this.YMarioA * a | 0) - 22, this.LargeMario.Update(a)) : (this.SmallMario.X = this
			.XMario + this.XMarioA * a | 0, this.SmallMario.Y = this.YMario + (this.YMarioA * a | 0) - 6, this
			.SmallMario.Update(a))
	}
};
Mario.MapState.prototype.TryWalking = function(a, b) {
	var c = this.XMario / 16 | 0,
		...
		d = c + a,
		f = e + b;
	if ((this.Level[d][f] === Mario.MapTile.Road || this.Level[d][f] === Mario.MapTile.Level) && !(this.Level[d][
			f] === Mario.MapTile.Road && this.Data[d][f] !== 0 && this.Data[c][e] !== 0 && this.Data[c][e] > -10))
		...
		for (c = 0; c <= 15; c++)
			for (b = 20; b >= 0; b--)
				if (this.Level[b][c] === Mario.MapTile.Water) {
					if (this.IsWater(b * 2 - 1, c * 2 - 1)) this.WaterSprite.X = b * 16 - 8, this.WaterSprite.Y =
						c * 16 - 8, this.WaterSprite.Draw(a, this.camera)
				} else if (this.Level[b][c] === Mario.MapTile.Decoration) this.DecoSprite.X = b * 16, this
			.DecoSprite.Y = c * 16, this.DecoSprite.Draw(a, this.camera);
		else if (this.Level[b][c] === Mario.MapTile.Level && this.Data[b][c] ===
			-2) this.HelpSprite.X = b * 16 + 16, this.HelpSprite.Y = c * 16 - 16, this.HelpSprite.Draw(a, this
			.camera);
...
Mario.MapState.prototype.LevelWon = function() {
	var a = this.XMario / 16,
		b = this.YMario / 16;
	this.Data[a][b] === -2 ? this.NextWorld() : (this.Data[a][b] = this.Data[a][b] !== -3 ? 0 : -10, this
		.RenderStatic())
};
...
Mario.LevelState = function(a, b) {
	...
	this.BgLayer = [];
	this.Paused = !1;
	this.Font = this.FontShadow = this.FireballsToCheck = this.ShellsToCheck = this.Camera = this.SpritesToRemove =
		this.SpritesToAdd = this.Sprites = null;
...
Mario.LevelState.prototype.Enter = function() {
	...
	this.FontShadow = Mario.SpriteCuts.CreateBlackFont();
	this.Font = Mario.SpriteCuts.CreateWhiteFont();
	for (a = 0; a < 2; a++) b = 4 >> a, c = ((this.Level.Width * 16 - 320) / b | 0) + 320, e = ((this.Level.Height *
		16 - 240) / b | 0) + 240, c = new Mario.BackgroundGenerator(c / 32 + 1, e / 32 + 1, a === 0, this
		.LevelType), this.BgLayer[a] = new Mario.BackgroundRenderer(c.CreateLevel(), 320, 240, b);
...
Mario.LevelState.prototype.Update = function(a) {
	...
	for (b = this.FireballsOnScreen = 0; b < this.Sprites.Objects.length; b++) d = this.Sprites.Objects[b], d !==
		Mario.MarioCharacter && (c = d.X - this.Camera.X,
			e = d.Y - this.Camera.Y, c < -64 || c > 384 || e < -64 || e > 304 ? this.Sprites.RemoveAt(b) :
			d instanceof Mario.Fireball && this.FireballsOnScreen++);
	if (this.Paused)
		for (b = 0; b < this.Sprites.Objects.length; b++) this.Sprites.Objects[b] === Mario.MarioCharacter ? this
			.Sprites.Objects[b].Update(a) : this.Sprites.Objects[b].UpdateNoMove(a);
	else {
		this.Layer.Update(a);
		this.Level.Update();
		b = !1;
		...
		for (c = (this.Camera.X / 16 | 0) - 1; c <= ((this.Camera.X + this.Layer.Width) / 16 | 0) + 1; c++)
			for (e = (this.Camera.Y / 16 | 0) - 1; e <= ((this.Camera.Y + this.Layer.Height) /
				...
				if (f !== null) f.LastVisibleTick !== this.Tick - 1 && (f.Sprite === null || !this.Sprites.Contains(
					f.Sprite)) && f.Spawn(this, c, e, d), f.LastVisibleTick = this.Tick;
				if (d !== 0 && (f = this.Level.GetBlock(c, e), (Mario.Tile.Behaviors[f & 255] & Mario.Tile
						.Animated) > 0 && (f % 16 / 4 | 0) === 3 && (f / 16 | 0) === 0 && (this.Tick - c * 2) %
						100 === 0)) {
					for (b = 0; b < 8; b++) this.AddSprite(new Mario.Sparkle(this, c * 16 + 8, e * 16 + (Math
						.random() *
		...
		for (b = 0; b < this.ShellsToCheck.length; b++)
			for (c = 0; c < this.Sprites.Objects.length; c++)
				if (this.Sprites.Objects[c] !== this.ShellsToCheck[b] && !this.ShellsToCheck[b].Dead && this.Sprites
					.Objects[c].ShellCollideCheck(this.ShellsToCheck[b]) &&
					Mario.MarioCharacter.Carried === this.ShellsToCheck[b] && !this.ShellsToCheck[b].Dead) Mario
					.MarioCharacter.Carried = null, this.ShellsToCheck[b].Die();
		for (b = this.ShellsToCheck.length = 0; b < this.FireballsToCheck.length; b++)
			for (c = 0; c < this.Sprites.Objects.length; c++) this.Sprites.Objects[c] !== this.FireballsToCheck[
				b] && !this.FireballsToCheck[b].Dead && this.Sprites.Objects[c].FireballCollideCheck(this
					.FireballsToCheck[b]) && this.FireballsToCheck[b].Die();
...
Mario.LevelState.prototype.Draw = function(a) {
	...
	for (b = 0; b < this.Sprites.Objects.length; b++) this.Sprites.Objects[b].Layer === 0 && this.Sprites.Objects[b]
		.Draw(a, this.Camera);
	a.restore();
	...
	a.save();
	a.translate(-this.Camera.X, -this.Camera.Y);
	for (b = 0; b < this.Sprites.Objects.length; b++) this.Sprites.Objects[b].Layer === 1 && this.Sprites.Objects[b]
		.Draw(a, this.Camera);
	a.restore();
	...
	if (Mario.MarioCharacter.WinTime > 0) {
		...
		this.RenderBlackout(a,
			Mario.MarioCharacter.XDeathPos - this.Camera.X | 0, Mario.MarioCharacter.YDeathPos - this.Camera.Y |
			0, 320 - b | 0)
	}
	if (Mario.MarioCharacter.DeathTime > 0) {
		b = Mario.MarioCharacter.DeathTime + this.Delta;
		b = b * b * 0.1;
		if (b > 900 && (Mario.MarioCharacter.Lives--, this.GotoMapState = !0, Mario.MarioCharacter.Lives <= 0)) this
			.GotoLoseState = !0;
		this.RenderBlackout(a, Mario.MarioCharacter.XDeathPos - this.Camera.X | 0, Mario.MarioCharacter.YDeathPos -
			this.Camera.Y | 0, 320 - b | 0)
	}
};
...
Mario.LevelState.prototype.RenderBlackout = function(a, b, c, e) {
	if (!(e > 320)) {
		for (var d = [], f = [], g = 0, g = 0; g < 16; g++) d[g] = b + Math.cos(g * Math.PI / 15) * e | 0, f[g] =
			c + Math.sin(g * Math.PI / 15) * e | 0;
		d[16] = 0;
		f[16] = c;
		d[17] = 0;
		f[17] = 240;
		...
		a.closePath();
		a.fill();
		for (g = 0; g < 16; g++) d[g] = b - Math.cos(g * Math.PI / 15) * e | 0, f[g] = c - Math.sin(g * Math.PI /
			15) * e | 0;
		f[15] += 5;
		d[16] = 320;
		f[16] = c;
...
Mario.LevelState.prototype.Bump = function(a, b, c) {
	var e = this.Level.GetBlock(a, b),
		d = 0,
		f = 0;
	(Mario.Tile.Behaviors[e & 255] & Mario.Tile.Bumpable) > 0 && (this.BumpInto(a, b - 1), this.Level.SetBlock(a, b,
		4), this.Level.SetBlockData(a, b, 4), (Mario.Tile.Behaviors[e & 255] & Mario.Tile.Special) > 0 ? (
		Enjine.Resources.PlaySound("sprout"), Mario.MarioCharacter.Large ? this.AddSprite(new Mario
			.FireFlower(this, a * 16 + 8, b * 16 + 8)) : this.AddSprite(new Mario.Mushroom(this, a * 16 + 8,
			b * 16 + 8))) : (Mario.MarioCharacter.GetCoin(), Enjine.Resources.PlaySound("coin"),
	...
	if ((Mario.Tile.Behaviors[e & 255] & Mario.Tile.Breakable) > 0 && (this.BumpInto(a, b - 1), c)) {
		...
		for (d = 0; d < 2; d++)
			for (f = 0; f < 2; f++) this.AddSprite(new Mario.Particle(this, a * 16 + d * 8 + 4, b * 16 + f * 8 + 4,
				(d * 2 - 1) * 4, (f * 2 - 1) * 4 - 8))
	}
};
Mario.LevelState.prototype.BumpInto = function(a, b) {
	var c = this.Level.GetBlock(a, b),
		e = 0;
	(Mario.Tile.Behaviors[c & 255] & Mario.Tile.PickUpable) > 0 && (Mario.MarioCharacter.GetCoin(), Enjine.Resources
		.PlaySound("coin"), this.Level.SetBlock(a, b, 0), this.AddSprite(new Mario.CoinAnim(a, b + 1)));
...
Mario.LevelState.prototype.CheckForChange = function(a) {
	this.GotoLoseState ? a.ChangeState(new Mario.LoseState) : this.GotoMapState && a.ChangeState(Mario
		.GlobalMapState)
};
